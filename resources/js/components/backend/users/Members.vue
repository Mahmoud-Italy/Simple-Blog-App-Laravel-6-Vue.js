            ...
            <div class="page-content">
              <nav class="page-breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item fontana active" aria-current="page">MEMBERS</li>
                </ol>
              </nav>
                          ...
                          <table class="table table-hover">
                            <thead>
                              <tr  class="head-tbl">
                                ...
                                <th class="text-center fontana" style="width: 25%">NAME</th>
                                <th class="text-center fontana" style="width: 25%">EMAIL</th>
                                <th class="text-center fontana" style="width: 10%">ACTION</th>
                              </tr>
                            </thead>
                            <tbody v-if="dataLoading">
                                <tr ><td colspan="4"><div class="loader sm-loader" style="left: 50%"></div></td></tr>
                            </tbody>
                            <tbody v-if="!dataLoading">
                              <tr v-if="total_data == 0"><td colspan="4" class="text-center"> {{ $t('app.no_data') }}</td></tr>
  ...
  export default {
    ...
    methods: {
      ...
      fetchData(page_url, loading=false) {
          ...
          page_url = page_url || '/api/v1/dashboard/members';
        ...
        addNew() {
            ...
            if(this.edit === false) {
                ...
                formData.append('accessToken', this.accessToken);
                axios.post('/api/v1/dashboard/member', formData, config)
                .then(res => {
                    this.row.name = '';
                    this.row.email = '';
                    this.row.password = '';
