                          ...
                          <table class="table table-hover">
                            <thead>
                              <tr>
                                ...
                                <th class="text-center" style="width:10%">POST IMAGE</th>
                                <th class="text-center" style="width:10%">USERNAME</th>
                                <th class="text-center" style="width:35%">COMMENT</th>
  ...
  export default {
    ...
    methods: {
      ...
      fetchData(page_url, loading=false) {
          ...
          page_url = page_url || '/api/v1/dashboard/comments';
        ...
        activeData(id) {
            ...
            formData.append('modelName', 'Comment');
            formData.append('accessToken', this.accessToken);
        ...
        deleteData(id) {
          if(confirm('Are You Sure?')) {
            ...
            axios.post('/api/v1/dashboard/comment', formData, config)
                .then(res => {
                this.fetchData();
                this.$noty.info(this.$i18n.messages[this.$i18n.locale].app.success_msg);
             })
