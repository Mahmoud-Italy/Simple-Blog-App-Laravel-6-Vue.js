...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="{{ url('assets/backend/vendors/bootstrap-datepicker/bootstrap-datepicker.min.css') }}">
    ...
    <body>
        ...
        <script src="{{ url('assets/backend/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js') }}"></script>
